									...
									<tbody>  {{$i = 1}}
										@foreach ( $pendingOrders as $order )
											<tr>
												...
												<td><a  href="{{ url('orders/view/'.$order->order_id)}}"  class="btn btn-info">See order</a></td>
												<td><a  href="{{ url('orders/pending/confirmation/'.$order->order_id) }}"  class="btn btn-info">Process order</a></td>
											</tr>
                                            {{$i=$i+1}}
										@endforeach
