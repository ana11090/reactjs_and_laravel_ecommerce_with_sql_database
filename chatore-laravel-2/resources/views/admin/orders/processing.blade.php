									...
									<tbody>  {{$i = 1}}
										@foreach ( $processingOrders as $order )
											<tr>
												...
												<td><a  href="{{ url('orders/processing/view/'.$order->order_id)}}"  class="btn btn-info">See order</a></td>
												<td><a  href="{{ url('orders/processing/confirmation/'.$order->order_id) }}"  class="btn btn-info">Completed order</a></td>
											</tr>
                                            {{$i=$i+1}}
										@endforeach
