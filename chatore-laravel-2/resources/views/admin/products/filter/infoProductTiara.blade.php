...
<div class="page-wrapper">
	<div class ="page-content">
		...
		<form class="row g-3" action="{{route('store.info.tiaras')}}" method="POST" enctype="multipart/form-data">
        @csrf
			{{-- Extra info title --}}
			<div class="card border-top border-0 border-4 border-primary">
				...
				{{-- style --}}
									...
									<label class="form-label">Choose style</label>
											<select  class="form-control"   name="tiara_filter_style">
											<option value="">Choose an option</option>    
											<option value="Regal">Regal</option>
											<option value="Wishbone">Wishbone</option>
											<option value="Double band">Double band</option>
											<option value="Headband">Headband</option>
											<option value="Bun wrap">Bun wrap</option>
