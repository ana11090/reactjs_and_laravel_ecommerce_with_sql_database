...
<div class="page-wrapper">
	<div class ="page-content">
		...
		<form class="row g-3" action="{{route('store.info.necklaces')}}" method="POST" enctype="multipart/form-data">
        @csrf
			{{-- Extra info title --}}
			<div class="card border-top border-0 border-4 border-primary">
				...
				{{-- style --}}
				<div class="col-md-6">
										<label class="form-label">Choose the lenght of the necklace:</label>
											<select  class="form-control"   name="necklace_filter_lenght">
											<option value="">Choose an option</option>    
											<option value="More options">More options</option>
											<option value="14">14 inches</option>
											<option value="16">16 inches</option>
											<option value="21">18 inches</option>
											<option value="20-24">20 to 24 inches</option>
											<option value="28-36">28 to 36 inches</option>
											<option value="36-42">36 to 42 inches</option>
											</select>
									</div>
									<div class="col-md-6">
									<label class="form-label">Choose style</label>
											<select  class="form-control"   name="necklace_filter_style">
											<option value="">Choose an option</option>    
											...
											<option value="Lavaliere">Lavaliere</option>
									...
									<label class="form-label">Choose gift type</label>
											<select  class="form-control"   name="necklace_filter_gift">
											<option value="">Choose an option</option>    
