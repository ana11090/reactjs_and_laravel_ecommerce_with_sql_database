...
<body>
	...
	<!--end switcher--><script src="{{ asset('backend/assets/plugins/chartjs/js/Chart.extension.js') }}"></script>
	<!-- Bootstrap JS --><script src="{{ asset('backend/assets/plugins/chartjs/js/chartjs-custom.js') }}"></script>
